...
RSpec.describe "StaticPages", type: :system do
  describe "トップページ" do
    context "ページ全体" do
      ...
      it "クックメニューの文字列が存在することを確認" do
        expect(page).to have_content 'クックメニュー'
      end
  ...
  describe "ヘルプページ" do
    ...
    it "クックメニューとは？の文字列が存在することを確認" do
      expect(page).to have_content 'クックメニューとは？'
    end

    it "正しいタイトルが表示されることを確認" do
      expect(page).to have_title full_title('クックメニューとは？')
    end
  end
